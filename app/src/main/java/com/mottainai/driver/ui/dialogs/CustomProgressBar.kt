...
class CustomProgressBar {
    ...
    fun show(context: Context, title:CharSequence?): Dialog {
        ...
        view.cp_cardview.setCardBackgroundColor(Color.parseColor("#70FFFFFF")) //Box Color
        setColorFilter(view.cp_pbar.indeterminateDrawable,
            ResourcesCompat.getColor(context.resources, R.color.colorPrimaryGreen, null)) //Progress Bar Color
