...
public class CompanyDetailsFragment extends Fragment implements View.OnClickListener, DialogFragmentListener {
    ...
    private String name, registrationNo, addressLineOne, addressLineTwo, pincode, country, state, city;
        ...
        ((SignupActivity) getActivity()).signupViewModel.getSignupFormState().observe(getViewLifecycleOwner(), new Observer<SignupFormState>() {
            ...
            public void onChanged(SignupFormState signupFormState) {
                if (signupFormState.isDataValid()) {
                    ...
                    bundle.putString("address", addressLineOne + " " + addressLineTwo);
                    ...
                    ((SignupActivity) getActivity()).replaceFragment(contactDetailsFragment,
    ...
    public void onClick(View v) {
        if (v == next) {
            ...
            registrationNo = editRegistration.getText().toString();
            ...
            ((SignupActivity) getActivity()).signupViewModel.signupCompanyDataChanged(name, registrationNo,
                    addressLineOne, addressLineTwo, pincode, country, state, city);
